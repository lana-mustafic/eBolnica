...
import { MedicationDetailComponent } from './pages/pharmacy/medications/medication-detail.component';
...
export const routes: Routes = [
    ...
    {path: 'pharmacy/medications/:id', component:MedicationDetailComponent, canActivate:[authGuard, roleGuard], data: {role: 'Pharmacist'}, title:'Medication Details'},
