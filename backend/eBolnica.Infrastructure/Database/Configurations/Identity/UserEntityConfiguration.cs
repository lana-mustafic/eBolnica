namespace eBolnica.Infrastructure.Database.Configurations.Identity;

public sealed class UserEntityConfiguration : IEntityTypeConfiguration<eBolnicaUserEntity>
{
    public void Configure(EntityTypeBuilder<eBolnicaUserEntity> b)
    {
        b.ToTable("Users");
