...
namespace eBolnica.Infrastructure.Common;

/// <summary>
/// Global exception handler for unhandled exceptions.
/// Keeps the same ErrorDto format as the previous middleware.
/// </summary>
public sealed class eBolnicaExceptionHandler(
    ILogger<eBolnicaExceptionHandler> logger,
...
) : IExceptionHandler
{
    public async ValueTask<bool> TryHandleAsync(HttpContext ctx, Exception ex, CancellationToken ct)
    {
        ...
        {
            eBolnicaNotFoundException => StatusCodes.Status404NotFound,
            eBolnicaConflictException or eBolnicaBusinessRuleException => StatusCodes.Status409Conflict,
