...
public sealed class JwtTokenService : IJwtTokenService
{
    ...
    public JwtTokenPair IssueTokens(eBolnicaUserEntity user)
    {
        ...
        if (user.IsAdmin && user.UserType != UserTypes.Admin)
            claims.Add(new Claim(ClaimTypes.Role, UserTypes.Admin));
