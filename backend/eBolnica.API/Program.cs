using eBolnica.API;
using eBolnica.API.Middleware;
using eBolnica.Application;
using eBolnica.Infrastructure;
using Serilog;
...
public partial class Program
{
    private static async Task Main(string[] args)
    {
        ...
        try
        {
            Log.Information("Starting eBolnica API...");
            ...
            Log.Information("eBolnica API started successfully.");
            app.Run();
        }
        ...
        catch (Exception ex)
        {
            ...
            Log.Fatal(ex, "eBolnica API terminated unexpectedly.");
        }
        finally
        {
