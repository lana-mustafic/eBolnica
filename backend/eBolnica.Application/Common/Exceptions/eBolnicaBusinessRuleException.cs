...
/// </summary>
public sealed class eBolnicaBusinessRuleException : Exception
{
    public string Code { get; }

    public eBolnicaBusinessRuleException(string code, string message)
        : base(message)
    {
        Code = code;
    }

    public eBolnicaBusinessRuleException(string code, string message, Exception? innerException)
