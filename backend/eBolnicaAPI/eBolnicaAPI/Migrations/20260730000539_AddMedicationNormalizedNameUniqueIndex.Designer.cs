...
namespace eBolnicaAPI.Migrations
{
    ...
    [Migration("20260730000539_AddMedicationNormalizedNameUniqueIndex")]
    partial class AddMedicationNormalizedNameUniqueIndex
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("eBolnicaAPI.Models.Entities.Medication", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            NormalizedName = "calcium carbonate",
                            Price = 280.00m,
                            RequiresPrescription = false,
                            StockQuantity = 400,
                            Strength = "500mg"
            ...
            modelBuilder.Entity("eBolnicaAPI.Models.Entities.MedicationImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("MedicationId", "IsPrimary")
                        .HasDatabaseName("IX_MedicationImages_MedicationId_IsPrimary");

                    b.ToTable("MedicationImages");
                });

            modelBuilder.Entity("eBolnicaAPI.Models.Entities.MedicationStockHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("MedicationId", "RecordedAt")
                        .HasDatabaseName("IX_MedicationStockHistory_MedicationId_RecordedAt");

                    b.ToTable("MedicationStockHistories");
                });
