    ...
    public class AppDbContext : IdentityDbContext<AppUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Patient>().HasData(
                ...
                new Patient { Id = 3, FirstName = patient3.LastName, LastName =patient3.LastName, AppUserId = "p3", Gender="Male", Address = "Address3", DateOfBirth = new DateTime(1992, 3, 15), MedicalRecordId = "MRID3", BloodType = "0", DoctorId = 1, PhoneNumber=patient3.PhoneNumber }
                );
        }
